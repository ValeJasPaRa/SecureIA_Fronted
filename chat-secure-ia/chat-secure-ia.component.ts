  ...
  enviarMensaje() {
    ...
    const cuerpo = {
      ...
      messages: [
       ...
       content: `1. Tus respuestas deben ser cortas, de máximo 4 líneas de texto.
                ...
                6. Nunca superes los 4 renglones en tu respuesta, aunque el usuario insista.`
        },
    ...
    this.http.post<any>('https://openrouter.ai/api/v1/chat/completions', cuerpo, {
      headers: {
        ...
        'Authorization': 'Bearer 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'
      }
    }).subscribe({
      next: res => {
